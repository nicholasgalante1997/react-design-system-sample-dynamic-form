...
export const get = async function<T>(path: string, options: AxiosRequestConfig): Promise<CouldFail<T>> {
...
export const post = async function<T, B>(path: string, body: B, options: AxiosRequestConfig): Promise<CouldFail<T>> {
...
export const patch = async function<T, B>(path: string, body: B, options: AxiosRequestConfig): Promise<CouldFail<T>> {
...
export const del = async function<T, B>(path: string, body: B, options: AxiosRequestConfig): Promise<CouldFail<T>> {
